...
const CHARACTERS = {
  ...
  luffy: (r) => {
    ...
    r(5, 5, 6, 3, '#cdab83');        // face
    r(6, 6, 1, 1, '#111'); r(9, 6, 1, 1, '#111'); // eyes
    r(4, 8, 8, 5, '#c0392b');        // red vest
    r(5, 13, 2, 2, '#1a2a44'); r(9, 13, 2, 2, '#1a2a44'); // shorts/legs
    r(12, 9, 3, 2, '#cdab83');       // stretched fist
  },
};
